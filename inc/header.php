		...
		<div class="wrap">
			<div class="navbar navbar-default navbar-static-top" style="margin-bottom: -25px; margin-top: -20px;">
				<ul class="agile_forms">
						<li><a class="active" href="<?=portal('');?>"> Sign In</a> </li>
					</ul>
				<div class="container">
					...
					<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav">
							<li class="active"><a href="<?= base_url('');?>"><span data-hover="Home" style="color: #fff; padding: 5px;">Home</span></a></li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="french_classes.php">French Language Studies</a></li>
									<li><a href="tutorial_sessions.php">Tutorial Sessions</a></li>
									<li><a href="research_assistance.php">Research Assistance</a></li>
								</ul>
							</li>
