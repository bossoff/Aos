...
<h3 style="">
		...
		<table class="table table-bordered datatable" id="table-4">
			...
			$check_active = mysqli_query($connect, "SELECT active FROM reg_courses WHERE user_level = '$user_level'");
			...
			// if($get_active['active']==1){
				...
				echo '<thead>
							<h6 style="">
				               ...
				               1st and 2nd Semester Register Courses
			            	</h6>
							<tr>
								<th>S/N</th>
						...
						<tbody>';
						$cnt=1; 
						$Query_register_course = mysqli_query($connect, "SELECT * FROM users INNER JOIN reg_courses ON users.user_id = reg_courses.uid INNER JOIN courses ON reg_courses.courseid = courses.cid WHERE uid = '$uid'")or die(mysqli_error($connect));
