<link rel="stylesheet" type="text/css" href="<?=base_home('css/aosacademy.css');?>">
				...
				<div class="row">
					...
					<div class="col-sm-3 col-lg-3">
						<div class="widget">
							<h4>Information</h4>
							<ul class="link-list">
								<li ><a href="<?= base_home('');?>"><span data-hover="Home" style="color: #fff; padding: 5px;">Home</span></a></li>
								<li><a href="#">Login</a></li>
								
							
									<li><a href="<?=base_home("");?>french_language.php">French Language Studies</a></li>
									<li><a href="<?=base_home("");?>tutorial_study.php">Tutorial Session</a></li>
									<li><a href="<?=base_home("");?>project_management.php">Research Assistance</a></li>
					...
					<div class="col-sm-3 col-lg-3">
						<div class="widget">
							<h4>Pages</h4>
							<ul class="link-list">
								<li><a href="<?=base_home("");?>about.php">About Us</a></li>
								<li><a href="<?=base_home("");?>gallery.php">Gallery</a></li>
								<li><a href="<?=base_home("");?>blog.php">blog</a></li>								
