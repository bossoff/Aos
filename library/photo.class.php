...
function embeddedImgevent($photo) {
   ...
   if(count($base64) >= 3) {
     ...
     if(count($base64) >= 2) {
       $base64 = str_replace(" ", "", $base64[1]);
       return ($photo != "" ? '<img alt="Embedded Image" width="650" class=" img-responsive" style="width:650px; height:450; -moz-border-radius:15px;" src="data:image/jpg;base64,'.$base64.'"/><br>' : "");
     }
   }
   return "";
}
