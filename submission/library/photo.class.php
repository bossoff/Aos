...
function embeddedImg($photo) {
   ...
   if(count($base64) >= 3) {
     ...
     if(count($base64) >= 2) {
       ...
       return ($photo != "" ? '<img alt="Embedded Image" width="132" class="blog_img img-responsive" style="width:132px; height:auto; border:solid 5px #f1f1f1; border-radius:15px; -moz-border-radius:15px;" src="data:image/jpg;base64,'.$base64.'"/><br>' : "");
     }
   }
   return "";
}
