<?php
 ...
 require (_LIB."user_checker.php"); 
 require (_LIB."for_all.php"); 
?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header" style="background: #49872E">
        <!-- Logo -->
        <a href="<?= base_url1('home.php');?>" class="logo">
            <!-- <img src="dist/img/logo.png" class="img-responsive" alt="" width="170" style="margin-top:0px; color:  red;" /> -->
            <?= $logo;?>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <i class="fa fa-users text-red"></i> <?php echo $count_row_new_user. ' '.$new_user;?>
                        </a>
                      </li>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <div class="pull-left info"><?= $user_avatar_source2; ?></div>
                  <span class="hidden-xs"> <?=$firstname_row;?> <?=$lastname_row;?></span>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <?= $user_avatar_source; ?>
                    <p>
                      <?=$firstname_row;?> <?=$lastname_row;?> - <?=$user_level_row;?>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?= base_url('lib/logout.php');?>" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
